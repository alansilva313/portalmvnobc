...
class DesbloquearSimCardController {
    desbloqueio(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                // ✅ Chamada à API
                const result = yield axios_1.default.post(`${URL_TIP}/simcard/${cleanSimcard}/desbloquear?user_token=${TOKEN_TIP}`);
                ...
                return res.status(200).json({
                    msg_usuario: ((_a = result.data) === null || _a === void 0 ? void 0 : _a.msg_usuario) || "Desbloqueio realizado com sucesso!",
...
exports.default = DesbloquearSimCardController;
